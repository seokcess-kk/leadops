...
export function MetricStrip() {
  ...
  const cells: Cell[] = [
    { key: "raw", label: "수집 후보", value: String(metrics.rawCandidates) },
    { key: "analyzed", label: "상세 분석", value: String(metrics.analyzed) },
    { key: "queue", label: "검수 대기", value: String(metrics.reviewQueue), highlight: true },
    { key: "approved", label: "승인", value: String(metrics.approved), sub: `/${metrics.approvalCap}` },
    { key: "rejected", label: "제외", value: String(metrics.rejected) },
    { key: "final", label: "최종 리드", value: String(metrics.finalLeads) },
  ];
