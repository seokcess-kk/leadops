...
| M1-상한 실제 존재율 (사람 라벨) | 61.6% `[51.1%, 71.2%]` (n=86) | — | **기준 70% 가 모집단 상한보다 높다** — 기준 재협상 필요 |
...
| robots.txt 403 | 1 | RFC 9309 는 4xx 를 허용으로 봐도 된다 — **발주자 결정 대기.** 허용하면 21/28 = **75%** 로 기준 도달 |
...
> 63% 를 찾는 셈**이다. 기준 70% 는 모집단 상한(61.6%)보다 높아 기준 자체의 재협상이
> 필요하다. 공식 판별 재현율은 FN 분해 기반 수정 4건(#13·#14) 후 39.3% → **71.4%** 다.
