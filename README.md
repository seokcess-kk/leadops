...
### ❗ 실측된 것 (2026-08-05 · 실키 · shadow ORS · 라벨 90건 · 시드 42)
...
| M7 ORS ↔ 체감 노출 ρ | 0.338 `[-0.086, 0.659]` (n=23) | CI 상한 <0.4 → stop | ✅ stop 아님 — n 이 13→23 으로 늘며 ρ 는 낮아졌다 |
...
| robots.txt 403 | 1 | ✅ **허용으로 결정·반영됨** (D-005) — 다음 실행부터 21/28 = **75%** 로 기준 도달 예상 |
